                                    ...
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        ...
                                        <?php
                                            ...
                                            if(check_if_added_to_cart($row["id"])){
                                              ...
                                              ?>
                                                 <a href='cart_add.php? id=<?php echo $row["id"];?>&navid=<?php echo "$id";?>' class="btn btn-block btn-primary" name="add" value="add" class="btn btn-block btr-primary">Add to cart</a>
                                               <?php
                                            }
                                        }
                                        ?>                                    
